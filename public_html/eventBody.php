                            ...
                            <div class="card card-raised card-carousel">
                                <div id="carousel-event" class="carousel slide" data-ride="carousel">
                                    ...
                                    <ol class="carousel-indicators">
                                        ...
                                        <li data-target="#carousel-event" data-slide-to="0"></li>
                                    </ol>
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item">
                                            <img class="img-responsive" src="assets/img/bg2.jpeg" alt="">
                                            <div class="carousel-caption">
                                                <h2>Sample Event 2</h2>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img class="img-responsive" src="assets/img/bg3.jpeg" alt="">
                                            <div class="carousel-caption">
                                                <h2>Sample Event 3</h2>
                                            </div>
                                        </div>
                                    </div>

                                    <!-- Controls -->
                                    <a class="left carousel-control" href="#carousel-event" data-slide="prev">
                                        <i class="material-icons black-icon">keyboard_arrow_left</i>
                                    </a>
                                    <a class="right carousel-control" href="#carousel-event" data-slide="next">
                                        <i class="material-icons black-icon">keyboard_arrow_right</i>
                                    </a>
                                </div>
                            </div>
