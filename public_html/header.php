            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a rel="tooltip" title="Follow us on Twitter" data-placement="bottom"
                       href="link.php?link=twitter" target="_blank" class="btn btn-simple">
                        <i class="fa fa-twitter"></i>
                    </a>
                </li>
                <li>
                    <a rel="tooltip" title="Like us on Facebook" data-placement="bottom"
                       href="link.php?link=facebook" target="_blank" class="btn btn-simple">
                        <i class="fa fa-facebook-square"></i>
                    </a>
                </li>
                <li>
                    <a rel="tooltip" title="Follow us on Instagram" data-placement="bottom"
                       href="link.php?link=instagram" target="_blank" class="btn btn-simple">
